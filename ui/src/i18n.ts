...
const messages: Record<Locale, Messages> = {
  en: {
    ...
    failedRenameProvider: 'Failed to rename provider.',
    failedRenameRule: 'Failed to rename rule.',
    failedRenameRouteTable: 'Failed to rename route table.',
    ...
    providerRenamed: ({ from, to }) => `Provider ${from} renamed to ${to}.`,
    ...
    regex: 'Regex',
    regexFullMatchHint: 'Matches the whole model name; use .* for partial matches.',
    removeFromTable: 'Remove from table',
    rename: 'Rename',
    renameProvider: 'Rename provider',
    renameProviderNote: ({ name }) => `Current name: ${name}`,
    renameRule: 'Rename rule',
    renameRuleNote: ({ id }) => `Current ID: ${id}`,
    renameRouteTable: 'Rename route table',
    renameRouteTableNote: ({ name }) => `Current name: ${name}`,
    ...
    routeTableRenamed: ({ from, to }) => `Route table ${from} renamed to ${to}.`,
    ...
    ruleRenamed: ({ from, to }) => `Rule ${from} renamed to ${to}.`,
  ...
  zh: {
    ...
    failedRenameProvider: '重命名 provider 失败。',
    failedRenameRule: '重命名规则失败。',
    failedRenameRouteTable: '重命名路由表失败。',
    ...
    providerRenamed: ({ from, to }) => `Provider ${from} 已重命名为 ${to}。`,
    ...
    refreshing: '刷新中',
    regex: '正则',
    regexFullMatchHint: '整串匹配模型名；要部分匹配请写 .*。',
    removeFromTable: '从路由表移除',
    rename: '重命名',
    renameProvider: '重命名 Provider',
    renameProviderNote: ({ name }) => `当前名称：${name}`,
    renameRule: '重命名规则',
    renameRuleNote: ({ id }) => `当前 ID：${id}`,
    renameRouteTable: '重命名路由表',
    renameRouteTableNote: ({ name }) => `当前名称：${name}`,
