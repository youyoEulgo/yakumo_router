...
const messages: Record<Locale, Messages> = {
  en: {
    ...
    addRules: 'Add rules',
    addSelectedRules: ({ count }) => `Add ${count} rule(s)`,
    apiKey: 'API Key',
    baseUrl: 'Base URL',
    cancel: 'Cancel',
    ...
    newRule: 'New rule',
    noAvailableRules: 'All rules are already in this table.',
    noProviders: 'No providers configured.',
    noRouteTables: 'No route tables configured.',
    noRules: 'No rules configured.',
    noVisibleRules: 'No rules added to this table yet.',
  ...
  zh: {
    ...
    addRules: '添加规则',
    addSelectedRules: ({ count }) => `添加 ${count} 条规则`,
    apiKey: 'API Key',
    baseUrl: 'Base URL',
    cancel: '取消',
    ...
    newRouteTable: '新建路由表',
    newRule: '新建规则',
    noAvailableRules: '所有规则都已加入该路由表。',
    noProviders: '还没有配置 provider。',
    noRouteTables: '还没有配置路由表。',
    noRules: '还没有配置规则。',
    noVisibleRules: '该路由表还没有添加规则。',
